...
// If domain is provided, returns models matching the corresponding endpoint.
// Domains: DefaultDomainGlobal (codebuddy.ai) or DefaultDomain (codebuddy.cn)
func GetCodeBuddyModels(domain string) []*ModelInfo {
	now := int64(1748044800) // 2025-05-24

	// 若传入全球域名，返回全球端点支持的模型
	if domain == "www.codebuddy.ai" {
		return []*ModelInfo{
			{
				ID:                  "enhance-1.0",
				Object:              "model",
			...
			},
			{
				...
				Description:         "与 GPT-5.1 Codex 类似，但更小、更便宜",
				ContextLength:       272000,
				MaxCompletionTokens: 72000,
				SupportedEndpoints:  []string{"/chat/completions"},
				Thinking:            &ThinkingSupport{ZeroAllowed: true},
			},
			{
				...
				Type:                "codebuddy",
				DisplayName:         "GPT-5",
				Description:         "OpenAI 的旗舰模型，适合规划、调试、编码等任务",
				ContextLength:       272000,
				MaxCompletionTokens: 72000,
				SupportedEndpoints:  []string{"/chat/completions"},
			},
			...
			},
			{
				...
				Description:         "GPT-5 的小型版本，更快、更便宜，适用于日常任务",
				ContextLength:       272000,
				MaxCompletionTokens: 72000,
				SupportedEndpoints:  []string{"/chat/completions"},
			},
			{
				...
				Description:         "超轻量版 GPT-5，针对极低成本与高速度进行了优化",
				ContextLength:       200000,
				MaxCompletionTokens: 72000,
				SupportedEndpoints:  []string{"/chat/completions"},
			},
			...
			},
			{
				...
				OwnedBy:             "codebuddy",
				Type:                "codebuddy",
				DisplayName:         "chat-1.0",
				Description:         "适用于对话任务的通用聊天模型",
				ContextLength:       200000,
				MaxCompletionTokens: 32000,
				SupportedEndpoints:  []string{"/chat/completions"},
			},
			{
				...
				OwnedBy:             "codebuddy",
				Type:                "codebuddy",
				DisplayName:         "completion-1.0",
				Description:         "用于快速文本生成的轻量级补全模型",
				ContextLength:       200000,
			...
			},
			{
				...
				OwnedBy:             "codebuddy",
				Type:                "codebuddy",
				DisplayName:         "completion-1.2",
				Description:         "性能改进的升级版补全模型",
				ContextLength:       200000,
				MaxCompletionTokens: 256,
				SupportedEndpoints:  []string{"/chat/completions"},
			},
			...
			},
			{
				...
				Description:         "谷歌的最新 flagship 模型，适合日常使用",
				ContextLength:       200000,
				MaxCompletionTokens: 32000,
				SupportedEndpoints:  []string{"/chat/completions"},
				Thinking:            &ThinkingSupport{ZeroAllowed: true},
			},
			{
				...
				Description:         "Google 的快速预览模型，支持多模态能力",
				ContextLength:       200000,
				MaxCompletionTokens: 32000,
				SupportedEndpoints:  []string{"/chat/completions"},
				Thinking:            &ThinkingSupport{ZeroAllowed: true},
			},
			{
				...
				Description:         "高效快速的 Gemini 模型，适合即时响应与轻量任务",
				ContextLength:       200000,
				MaxCompletionTokens: 32000,
				SupportedEndpoints:  []string{"/chat/completions"},
			},
			{
				...
				Description:         "适用于大型重构、导航/搜索和问题求解",
				ContextLength:       200000,
			...
			},
			{
				...
				Description:         "DeepSeek-V3.2 模型，适合日常使用",
				ContextLength:       96000,
				MaxCompletionTokens: 32000,
				SupportedEndpoints:  []string{"/chat/completions"},
				Thinking:            &ThinkingSupport{ZeroAllowed: true},
...
func GetStaticModelDefinitionsByChannel(channel string) []*ModelInfo {
	...
	case "codebuddy":
		return GetCodeBuddyModels("www.codebuddy.cn")
	case "cursor":
...
func LookupStaticModelInfo(modelID string) *ModelInfo {
	...
	allModels := [][]*ModelInfo{
		...
		GetKiloModels(),
		GetAmazonQModels(),
		GetCodeBuddyModels("www.codebuddy.cn"),
		GetCursorModels(),
	}
